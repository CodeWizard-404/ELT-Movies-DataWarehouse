		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:HNYu9GOPADDXQdeHXeCvHaBiDIfkzEBHC44KZQ==");
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1
							+ "`(`movie_id` INT(10)  ,`IMDB_ID` VARCHAR(10)  ,`title` VARCHAR(255)  ,`genre` VARCHAR(255)  ,`time` VARCHAR(10)  ,primary key(`movie_id`))");
				}
				java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1
						.prepareStatement("SELECT COUNT(1) FROM `" + "Movies" + "` WHERE `movie_id` = ?");
				resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
				String insert_tDBOutput_1 = "INSERT INTO `" + "Movies"
						+ "` (`movie_id`,`IMDB_ID`,`title`,`genre`,`time`) VALUES (?,?,?,?,?)";
				...
				String update_tDBOutput_1 = "UPDATE `" + "Movies"
						+ "` SET `IMDB_ID` = ?,`title` = ?,`genre` = ?,`time` = ? WHERE `movie_id` = ?";
				...
				util_tLogRow_1.addRow(new String[] { "movie_id", "IMDB_ID", "title", "genre", "time", });
...
// Start of branch "row1"
						if (row1 != null) {
							...
							row1.titleType.equals("movie") || row1.titleType.equals("tvMovie")
...
// # Output table : 'Movies'
									Movies_tmp.movie_id = Numeric.sequence("movie_id", 1, 1);
									Movies_tmp.IMDB_ID = row1.tconst;
									Movies_tmp.title = row1.primaryTitle;
...
// Start of branch "Movies"
								if (Movies != null) {
									...
									if ("\\N".equals(Movies.time)) {
										row4.movie_id = Movies.movie_id;
										row4.IMDB_ID = Movies.IMDB_ID;
										row4.title = Movies.title;
										row4.genre = Movies.genre;
									...
									try {
										row5.movie_id = TypeConvert.Integer2Integer(row4.movie_id);
									} catch (java.lang.Exception e) {
									...
									try {
										if ("".equals(row4.IMDB_ID)) {
											row4.IMDB_ID = null;
										}
										row5.IMDB_ID = TypeConvert.String2String(row4.IMDB_ID);
									} catch (java.lang.Exception e) {
										globalMap.put("tConvertType_1_ERROR_MESSAGE", e.getMessage());
										bHasError_tConvertType_1 = true;
										throw e;
									...
									try {
										if ("".equals(row4.title)) {
											row4.title = null;
										}
										row5.title = TypeConvert.String2String(row4.title);
									} catch (java.lang.Exception e) {
										globalMap.put("tConvertType_1_ERROR_MESSAGE", e.getMessage());
										bHasError_tConvertType_1 = true;
										throw e;
									...
									try {
										if ("".equals(row4.genre)) {
											row4.genre = null;
										}
										row5.genre = TypeConvert.String2String(row4.genre);
									} catch (java.lang.Exception e) {
										globalMap.put("tConvertType_1_ERROR_MESSAGE", e.getMessage());
										bHasError_tConvertType_1 = true;
										throw e;
									...
									try {
										...
										row5.time = TypeConvert.String2String(row4.time);
									} catch (java.lang.Exception e) {
										globalMap.put("tConvertType_1_ERROR_MESSAGE", e.getMessage());
										bHasError_tConvertType_1 = true;
										throw e;
...
// Start of branch "row5"
									if (row5 != null) {
										...
										row3.movie_id = row5.movie_id;
										row3.IMDB_ID = row5.IMDB_ID;
										row3.title = row5.title;
										row3.genre = row5.genre;
										row3.time = row5.time;
...
///////////////////////		
											...
											if (row3.movie_id != null) { //
												row_tLogRow_1[0] = String.valueOf(row3.movie_id);

											} //

											if (row3.IMDB_ID != null) { //
												row_tLogRow_1[1] = String.valueOf(row3.IMDB_ID);

											} //

											if (row3.title != null) { //
												row_tLogRow_1[2] = String.valueOf(row3.title);

											} //

											if (row3.genre != null) { //
												row_tLogRow_1[3] = String.valueOf(row3.genre);

											} //

											if (row3.time != null) { //
												row_tLogRow_1[4] = String.valueOf(row3.time);
...
///////////////////////    			
											...
											if (row2.movie_id == null) {
												...
												pstmt_tDBOutput_1.setInt(1, row2.movie_id);
											}
											...
											if (checkCount_tDBOutput_1 > 0) {
												if (row2.IMDB_ID == null) {
													...
													pstmtUpdate_tDBOutput_1.setString(1, row2.IMDB_ID);
												}

												if (row2.title == null) {
													pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
												} else {
													pstmtUpdate_tDBOutput_1.setString(2, row2.title);
												}

												if (row2.genre == null) {
													pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
												} else {
													pstmtUpdate_tDBOutput_1.setString(3, row2.genre);
												}

												if (row2.time == null) {
													pstmtUpdate_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
												} else {
													pstmtUpdate_tDBOutput_1.setString(4, row2.time);
												}

												if (row2.movie_id == null) {
													pstmtUpdate_tDBOutput_1.setNull(5 + count_tDBOutput_1,
												...
												if (row2.movie_id == null) {
													...
													pstmtInsert_tDBOutput_1.setInt(1, row2.movie_id);
												}

												if (row2.IMDB_ID == null) {
													pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
												} else {
													pstmtInsert_tDBOutput_1.setString(2, row2.IMDB_ID);
												}

												if (row2.title == null) {
													pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
												} else {
													pstmtInsert_tDBOutput_1.setString(3, row2.title);
												}

												if (row2.genre == null) {
													pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
												} else {
													pstmtInsert_tDBOutput_1.setString(4, row2.genre);
												}

												if (row2.time == null) {
													pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
												} else {
													pstmtInsert_tDBOutput_1.setString(5, row2.time);
												}
...
/************************************************************************************************
 * 127889 characters generated by Talend Open Studio for Data Integration on the
 * December 6, 2024 at 9:44:45 AM CET
 ************************************************************************************************/