...
package movies.shadowfileinputtodelimitedoutput_0_1;
...
public class ShadowFileInputToDelimitedOutput implements TalendJob {
	...
	public static class RowStruct implements routines.system.IPersistableRow<RowStruct> {
		final static byte[] commonByteArrayLock_MOVIES_ShadowFileInputToDelimitedOutput = new byte[0];
		static byte[] commonByteArray_MOVIES_ShadowFileInputToDelimitedOutput = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_MOVIES_ShadowFileInputToDelimitedOutput.length) {
					if (length < 1024 && commonByteArray_MOVIES_ShadowFileInputToDelimitedOutput.length == 0) {
						commonByteArray_MOVIES_ShadowFileInputToDelimitedOutput = new byte[1024];
					} else {
						commonByteArray_MOVIES_ShadowFileInputToDelimitedOutput = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_MOVIES_ShadowFileInputToDelimitedOutput, 0, length);
				strReturn = new String(commonByteArray_MOVIES_ShadowFileInputToDelimitedOutput, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_MOVIES_ShadowFileInputToDelimitedOutput, 0, length);
				strReturn = new String(commonByteArray_MOVIES_ShadowFileInputToDelimitedOutput, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_MOVIES_ShadowFileInputToDelimitedOutput) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited = (new java.io.File(
						"C:/Users/Kayto/Desktop/IT/Projects/ISET/ELT-Movies-DataWarehouse/Project/MOVIES/temp/preview/name.basics.csv"))
					...
					try {// TD110 begin
						if (filename_tFileInputDelimited instanceof java.io.InputStream) {
							...
							csvReadertFileInputDelimited = new com.talend.csv.CSVReader(
									...
									fieldSeparator_tFileInputDelimited[0], "US-ASCII");
						} else {
							csvReadertFileInputDelimited = new com.talend.csv.CSVReader(
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ShadowFileInputToDelimitedOutput.class.getClassLoader().getResourceAsStream(
					"movies/shadowfileinputtodelimitedoutput_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 55330 characters generated by Talend Open Studio for Data Integration on the
 * December 5, 2024 at 9:41:28 PM CET
 ************************************************************************************************/